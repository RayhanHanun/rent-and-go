...
const BENEFITS_DATA = [
  {
    icon: Map,
    title: 'Perjalanan Fleksibel',
    desc: 'Tentukan destinasi wisata sesuai kebutuhan perjalanan rombonganmu.'
  },
  {
    icon: Navigation,
    title: 'Driver Merangkap Guide',
    desc: 'Layanan pengemudi yang membantu perjalanan wisata lebih nyaman.'
  },
  {
    icon: Tag,
    title: 'Harga Transparan',
    desc: 'Proses cepat dan harga transparan untuk setiap perjalanan Anda.'
  }
];
    ...
    <div className="bg-slate-50 min-h-screen">
      ...
      <section className="relative w-full h-[50vh] bg-slate-950 flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: `url('https://images.unsplash.com/photo-1600185365926-3a2ce3cdb9eb?q=80&w=2670&auto=format&fit=crop')`,
          }}
        />
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto mt-10">
          ...
          >
            Temukan kendaraan dan layanan perjalanan wisata yang kamu butuhkan
            dalam satu tempat.
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-12">
            <h2 className="text-3xl font-bold text-slate-900 mb-4 border-l-4 border-slate-900 pl-4">
              Pilihan Armada Paket Tour
            </h2>
            <p className="text-slate-500 max-w-2xl">
              Nikmati perjalanan lebih nyaman dengan pilihan armada untuk
              keluarga hingga rombongan.
            </p>
          </div>
      ...
      <section className="py-24 bg-white border-t border-slate-100">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-slate-900 mb-6">
            Punya Kebutuhan Perjalanan Khusus?
          </h2>
          <p className="text-slate-500 mb-10 max-w-xl mx-auto">
            Konsultasikan rute wisata, durasi, dan kebutuhan rombongan Anda
            bersama tim kami melalui WhatsApp.
          </p>
          <a
          ...
          >
            ...
            Konsultasi Perjalanan via WhatsApp
          </a>
        </div>
      </section>
    </div>
